...
%-------------------------------------------------------------------------------
\title{%
Prototyping a protocol-driven deterministic-mapping based\\
system for the evaluation of abdominal pain in OPD setting
}
% \subtitle{
%   A project under Linguistic-agnostic Intelligent Support Systems for\\
